...
import { iocContainer } from './../modules/ioc';
...
const models: TsoaRoute.Models = {
    ...
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "UserCreationPayloadType": {
        "dataType": "refObject",
        "properties": {
            "email": {"dataType":"string","required":true,"validators":{"minLength":{"errorMsg":"Email is required","value":1},"pattern":{"errorMsg":"Email is not correct","value":"^\\w+([\\.-]?\\w+)*@\\w+([\\.-]?\\w+)*(\\.\\w{2,3})+$"}}},
            "name": {"dataType":"string","required":true,"validators":{"minLength":{"errorMsg":"Name is required","value":1}}},
        },
        "additionalProperties": false,
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    ...
    // ###########################################################################################################
        app.get('/rest/users/:userId',
            ...
            const args = {
                    ...
                    name: {"in":"query","name":"name","dataType":"any"},
            };
        ...
        app.post('/rest/users',
            ...
            const args = {
                    requestBody: {"in":"body","name":"requestBody","required":true,"ref":"UserCreationPayloadType"},
            };
